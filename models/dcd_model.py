...
class DCDModel(BaseModel):
    ...
    def data_dependent_initialize(self, data, label):
    ...
    def compute_G_loss(self):
        ...
        self.loss_G_L1 = self.criterionL1(self.recovery_A, self.real_A) * self.opt.cyc_L1 + self.criterionL1(self.identity_A,self.real_A) * self.opt.lambda_identity + self.criterionL1(self.recovery_B,self.real_B) * self.opt.cyc_L1 + self.criterionL1(self.identity_B, self.real_B) * self.opt.lambda_identity
        ...
        self.loss_G = (self.loss_G_A + self.loss_G_B) * 0.5 + loss_NCE_both + self.loss_G_L1
